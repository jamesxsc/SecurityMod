    ...
    public Screen getConfigurationScreen(BlockEntity cameraBlockEntity) {
        Screen screen = new Screen(NarratorManager.EMPTY) {
            ...
            public void init() {
                ...
                FilteredTextFieldWidget addressBox1 = new FilteredTextFieldWidget(this.font, this.width / 2 - (addressBoxWidth * 2 + 5), baseY + 132, addressBoxWidth, 15, "",
                        (Predicate<String>) s -> s.matches("^[0-9]*$"));
                addressBox1.setSuggestion("192");
                addressBox1.setMaxLength(3);
                FilteredTextFieldWidget addressBox2 = new FilteredTextFieldWidget(this.font, this.width / 2 - (addressBoxWidth * 1 + 0), baseY + 132, addressBoxWidth, 15, "",
                        (Predicate<String>) s -> s.matches("^[0-9]*$"));
                addressBox2.setSuggestion("168");
                addressBox2.setMaxLength(3);
                FilteredTextFieldWidget addressBox3 = new FilteredTextFieldWidget(this.font, this.width / 2 + (addressBoxWidth * 0 + 5), baseY + 132, addressBoxWidth, 15, "",
                        (Predicate<String>) s -> s.matches("^[0-9]*$"));
                addressBox3.setSuggestion("1");
                addressBox3.setMaxLength(3);
                FilteredTextFieldWidget addressBox4 = new FilteredTextFieldWidget(this.font, this.width / 2 + (addressBoxWidth * 1 + 10), baseY + 132, addressBoxWidth, 15, "",
                        (Predicate<String>) s -> s.matches("^[0-9]*$"));
                ...
                FilteredTextFieldWidget scopeBox1 = new FilteredTextFieldWidget(this.font, this.width / 2 - (addressBoxWidth * 2 + 5), baseY + 164, addressBoxWidth, 15, "",
                        s -> s.matches("^[xX0-9]*$"));
                scopeBox1.setSuggestion("192");
                scopeBox1.setMaxLength(3);
                FilteredTextFieldWidget scopeBox2 = new FilteredTextFieldWidget(this.font, this.width / 2 - (addressBoxWidth * 1 + 0), baseY + 164, addressBoxWidth, 15, "",
                        s -> s.matches("^[xX0-9]*$"));
                scopeBox2.setSuggestion("168");
                scopeBox2.setMaxLength(3);
                FilteredTextFieldWidget scopeBox3 = new FilteredTextFieldWidget(this.font, this.width / 2 + (addressBoxWidth * 0 + 5), baseY + 164, addressBoxWidth, 15, "",
                        s -> s.matches("^[xX0-9]*$"));
                scopeBox3.setSuggestion("1");
                scopeBox3.setMaxLength(3);
                FilteredTextFieldWidget scopeBox4 = new FilteredTextFieldWidget(this.font, this.width / 2 + (addressBoxWidth * 1 + 10), baseY + 164, addressBoxWidth, 15, "",
                        s -> s.matches("^[xX0-9]*$"));
            ...
            public void render(int int_1, int int_2, float float_1) {
                ...
                //network settings
                this.drawCenteredString(this.font, new TextComponent("Network Settings").setStyle(new Style().setUnderline(true)).getFormattedText(), this.width / 2, baseY + 105, 16777215);
                this.drawCenteredString(this.font, new TextComponent("Device Address").getFormattedText(), this.width / 2, baseY + 120, 16777215);
                this.drawCenteredString(this.font, new TextComponent("Scope").getFormattedText(), this.width / 2, baseY + 152, 16777215);
